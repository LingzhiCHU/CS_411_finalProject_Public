<?php
	...
	// echo "checkout".$checkout;
		...
		while ($checkin != $checkout) {
			...
			$max_id = $data['MAX(id)'];
			if ($max_id == "") {
				echo "Sorry, this hotel is not available during your desired days.";
				exit(1);
			}
...
?>
	...
	<form method="post">
 	...
 	<input name= "input_checkin" type="date" />
 	<input name= "input_checkout" type="date"  />
 	<input name= "input_room" type="text" />
